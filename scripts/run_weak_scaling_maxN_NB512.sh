#!/bin/bash
# Maximum N Weak Scaling with NB=512
# Uses largest possible N values with NB=512
# Compares Native DGEMM vs GEMMul8 (Ozaki-2 INT8 emulation)
#
# Usage: ./run_weak_scaling_maxN_NB512.sh [--native-only | --gemmul8-only]
...
# All values are multiples of NB=512
N1_NATIVE=98304    # 1 GPU: 192*512
N2_NATIVE=138752   # 2 GPU: 271*512
N4_NATIVE=196608   # 4 GPU: 384*512
N8_NATIVE=277504   # 8 GPU: 542*512

# GEMMul8 N values (~93 GB per GPU + workspace)
N1_GEMMUL8=64512   # 1 GPU: 126*512
N2_GEMMUL8=91136   # 2 GPU: 178*512
N4_GEMMUL8=129024  # 4 GPU: 252*512
N8_GEMMUL8=182272  # 8 GPU: 356*512
...
print_header "Maximum N Weak Scaling with NB=${NB}"
echo ""
