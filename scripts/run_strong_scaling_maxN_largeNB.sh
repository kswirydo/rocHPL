#!/bin/bash
# Maximum N Strong Scaling with Large NB (1024)
# Fixed large N, varying number of GPUs, with NB=1024
# Compares Native DGEMM vs GEMMul8 (Ozaki-2 INT8 emulation)
#
# Usage: ./run_strong_scaling_maxN_largeNB.sh [--native-only | --gemmul8-only]
...
# Fixed N values (must be multiples of NB=1024)
N_NATIVE=98304   # 96*1024, ~216 GB for 1 GPU
N_GEMMUL8=64512  # 63*1024, ~93 GB for 1 GPU + workspace
...
print_header "Maximum N Strong Scaling with Large NB=${NB}"
echo ""
